...
/bin/echo -e "validation_key '/tmp/kitchen/cookbooks/ap_ubuntu_bootstrap/recipes/validator.pem'" >> /etc/chef/client.rb
...
/bin/echo -e "policy_name 'linux_patch'" >> /etc/chef/client.rb
EOH
end
